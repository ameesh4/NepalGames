...
func main() {
	...
	router.POST("/api/addcategory", services.AddCategory)
	router.POST("/api/getcategories", services.GetCategories)
	router.POST("/api/deletecategory", services.DeleteCategory)
